...
(() => {
    ...
    $.ajax({
        type: "POST",
        url: baseurl + "/environment/gettemperatureinfo",
        async:false,
        success:(data)=>{
...
(() => {
    ...
    $.ajax({
        type: "POST",
        url: baseurl + "/environment/gethumidityinfo",
        async:false,
        success:(data)=>{
            option.xAxis.data = data.X;
            option.series[0].data = data.Y;
...
(() => {
    ...
    $.ajax({
        type: "POST",
        url: baseurl + "/environment/getwindspeedinfo",
        async:false,
        success:(data)=>{
            option.xAxis.data = data.X;
            option.series[0].data = data.Y;
...
(function () {
    ...
    $.ajax({
        type: "POST",
        url: baseurl + "/environment/getpm25info",
        async:false,
        success:(data)=>{
            option.xAxis.data = data.X;
            option.series[0].data = data.Y;
