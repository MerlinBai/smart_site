    ...
    <el-table v-loading="loading" :data="informList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="通知类型" align="center" prop="informType">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_notice_type" :value="scope.row.informType"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="通知内容">
          <editor v-model="form.informContent" :min-height="192"/>
        </el-form-item>
        <el-form-item label="通知文件" prop="infromFile">
          <file-upload v-model="form.infromFile"/>
        </el-form-item>
      </el-form>
